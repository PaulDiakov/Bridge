    Bridge.define("Bridge.Console", {
        statics: {
            ...
            ctors: {
                init: function () {
                    Object.defineProperty(this, "BODY_WRAPPER_ID", {
                        get: function() {
                            return this._BODY_WRAPPER_ID$ === undefined ? (this._BODY_WRAPPER_ID$ = "bridge-body-wrapper") : this._BODY_WRAPPER_ID$;
                        },
                        set: function(v) {
                            this._BODY_WRAPPER_ID$ = v;
                        }
                    });
                    Object.defineProperty(this, "CONSOLE_MESSAGES_ID", {
                        get: function() {
                            return this._CONSOLE_MESSAGES_ID$ === undefined ? (this._CONSOLE_MESSAGES_ID$ = "bridge-console-messages") : this._CONSOLE_MESSAGES_ID$;
                        },
                        set: function(v) {
                            this._CONSOLE_MESSAGES_ID$ = v;
                        }
                    });
                    Object.defineProperty(this, "position", {
                        get: function() {
                            return this._position$ === undefined ? (this._position$ = "horizontal") : this._position$;
                        },
                        set: function(v) {
                            this._position$ = v;
                        }
