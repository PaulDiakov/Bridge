...
{
    public class PointerReferenceBlock : ConversionBlock
    {
        public PointerReferenceBlock(IEmitter emitter, PointerReferenceExpression memberReferenceExpression)
        ...
        public PointerReferenceExpression MemberReferenceExpression
        {
            get;
            set;
        }
        ...
        {
            PointerReferenceExpression memberReferenceExpression = this.MemberReferenceExpression;
                ...
                )
            {
                ...
                if (parentInvocation == null || parentInvocation.Target != memberReferenceExpression)
                {
                    ...
                    {
                        inline = PointerReferenceBlock.GenerateInlineForMethodReference(method, this.Emitter);
                    }
                }
            }
